                ...
                <div className="md:col-span-2 flex flex-col mt-20 mx-10">
                    <form>
                        ...
                        <div className="flex flex-col mb-5">
                            <input type="text" className="h-12 md:h-14 w-full border-b-4 pl-3 placeholder:text-[#A0A3BD] placeholder:tracking-wider" placeholder="Enter your username" />
                        </div>
                        <div className="flex flex-col mb-5">
                        ...
                        <p className="text-center text-[#8692A6] tracking-wide text-sm md:text-md">
                            Already have an account? Let’s<a href="/sign-up" className="text-[#5F2EEA] underline underline-offset-4 font-semibold">Login</a>
                        </p>
                    </form>
                </div>
            </div>
