...
function StatusTransf() {
    const [showModal, setShowModal] = useState(false);
    const [transferStatus, setTransferStatus] = useState("failed"); // State untuk mengatur status transfer
    ...
    // Fungsi untuk mengubah status transfer menjadi "failed"
    ...
    return (
        ...
        <div className="relative">
            ...
            {transferStatus === "success" ? (
                ...
                <button className="bg-primary w-[100px] p-2 text-white text-xs rounded-lg font-bold ">
                    Back to Home
                </button>
                </>
                ) : (
                <button
                    ...
                    onClick={() => setTransferStatus("success")}
                >
                    Try Again
                </button>
                )} 
